...
def build_image_dataset(args):
    ...
    if args.dataset == 'imagenet':
        ...
        dataset_train = StanfordCars(os.path.join(args.data_path, 'stanford_cars'), split='train', transform=transform_train, download=True)
        dataset_val = StanfordCars(os.path.join(args.data_path, 'stanford_cars'), split='test', transform=transform_val, download=True)
        nb_classes = 196
        metric = "accuracy"
